...
type HelloWorldStatus struct {
	...
	FirstGreetingExtended bool   `json:"firstGreetingExtended,omitempty"`
	PreviousMentionedName string `json:"previousMentionedName,omitempty"`
}
